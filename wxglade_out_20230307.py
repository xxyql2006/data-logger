    ...
    def do_logging(self, event):
        ...
        try:
            ...
            with open(data_file, 'a', newline='') as csvfile:
                ...
                sleep(0.1)
                raw_PD_data = np.array(master.execute(slave_addr, cst.READ_INPUT_REGISTERS, 350, 24)) # DTR warning and alarm limits
                sleep(0.1)
                raw_PD_status = np.array(master.execute(slave_addr, cst.READ_INPUT_REGISTERS, 374, 24)) # DTR warning and alarm limits
                sleep(0.1)

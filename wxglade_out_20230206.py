...
# -*- coding: ISO-8859-1 -*-
#
# generated by wxGlade 1.0.4 on Tue Feb  7 09:21:09 2023
#
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        _icon = wx.NullIcon
        _icon.CopyFromBitmap(wx.Bitmap("C:\\Users\\cnbofan1\\ABB\\Safe Digital in CN - Documents - Documents\\99_Others\\TR_GP_PD data logger_final_bob\\TRlogo.png", wx.BITMAP_TYPE_ANY))
        self.SetIcon(_icon)
        ...
        self.grid_5 = wx.grid.Grid(self.notebook_1_pane_1, wx.ID_ANY, size=(1, 1))
        self.grid_5.CreateGrid(1, 4)
        self.grid_5.SetRowLabelSize(100)
        self.grid_5.SetColLabelSize(32)
        self.grid_5.SetSelectionMode(wx.grid.Grid.SelectColumns)
        self.grid_5.SetColLabelValue(0, "Moisture (ppmv)")
        self.grid_5.SetColSize(0, 120)
        self.grid_5.SetColLabelValue(1, u"Dew temp Td (\u2103)")
        self.grid_5.SetColSize(1, 120)
        self.grid_5.SetColLabelValue(2, u"Dew temp Td0 (\u2103)")
        self.grid_5.SetColSize(2, 120)
        self.grid_5.SetColLabelValue(3, "RH in % ")
        self.grid_5.SetColSize(3, 100)
        self.grid_5.SetRowLabelValue(0, "Unit_1")
        self.grid_5.SetMinSize(wx.DLG_UNIT(self.grid_5, wx.Size(206, 30)))
        sizer_2.Add(self.grid_5, 1, wx.ALL | wx.EXPAND, 3)

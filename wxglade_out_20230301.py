...
# -*- coding: ISO-8859-1 -*-
#
# generated by wxGlade 1.0.4 on Wed Mar  1 15:42:07 2023
#
...
class MyFrame(wx.Frame):
    ...
    def do_logging(self, event):
        ...
        try:
            ...
            with open(data_file, 'a', newline='') as csvfile:
                ...
                sleep(0.1)
                raw_mano1 = np.array(master.execute(slave_addr, cst.READ_INPUT_REGISTERS, 500, 4)) # manometer 1
                raw_mano2 = np.array(master.execute(slave_addr, cst.READ_INPUT_REGISTERS, 508, 4)) # manometer 2
                sleep(0.1)
                ...
                sleep(0.1)
                raw_humid = np.array(master.execute(slave_addr, cst.READ_INPUT_REGISTERS, 311, 8)) # Micro-moisture data
                sleep(0.1)
                # raw_unit1_dew = np.array(master.execute(slave_addr, cst.READ_INPUT_REGISTERS, 312, 1)) # Micro-moisture data
                # raw_unit1_dew_p0 = np.array(master.execute(slave_addr, cst.READ_INPUT_REGISTERS, 313, 1))# Micro-moisture data
                # raw_unit1_RH = np.array(master.execute(slave_addr, cst.READ_INPUT_REGISTERS, 314, 1)) # Micro-moisture data
                # raw_unit2_ppmv = np.array(master.execute(slave_addr, cst.READ_INPUT_REGISTERS, 315, 1)) # Micro-moisture data
                # raw_unit2_dew = np.array(master.execute(slave_addr, cst.READ_INPUT_REGISTERS, 316, 1)) # Micro-moisture data
                # raw_unit2_dew_p0 = np.array(master.execute(slave_addr, cst.READ_INPUT_REGISTERS, 317, 1))# Micro-moisture data
                # raw_unit2_RH = np.array(master.execute(slave_addr, cst.READ_INPUT_REGISTERS, 318, 1)) # Micro-moisture data
                ...
                self.grid_3.SetCellValue([0, 4], str(raw_humid[0])) # humid
                self.grid_3.SetCellValue([0, 5], '{:.2f}'.format(self.signed_to_int(raw_humid[1]) * 0.01)) # Dew temp with pressure Td
                self.grid_3.SetCellValue([0, 6], '{:.2f}'.format(self.signed_to_int(raw_humid[2]) * 0.01)) # Dew temp with norminal pressure Td0
                self.grid_3.SetCellValue([0, 7], str(raw_humid[3] * 0.01)) # Relative humidity RH
                ...
                self.grid_3.SetCellValue([1, 4], str(raw_humid[4])) # humid
                self.grid_3.SetCellValue([1, 5], '{:.2f}'.format(self.signed_to_int(raw_humid[5]) * 0.01)) # Dew temp with pressure Td
                self.grid_3.SetCellValue([1, 6], '{:.2f}'.format(self.signed_to_int(raw_humid[6]) * 0.01)) # Dew temp with norminal pressure Td0
                self.grid_3.SetCellValue([1, 7], str(raw_humid[7] * 0.01)) # Relative humidity RH
                ...
                self.grid_4.SetCellValue([0, 0], '{:.2f}'.format(self.signed_to_int(raw_PD1_data[0]) * 0.1)) # PD intensity unit1
                self.grid_4.SetCellValue([0, 1], '{:.2f}'.format(self.signed_to_int(raw_PD1_data[0]) * 0.1)) # PD frequency unit1
                ...
                line_buf['Unit1_Mano_ppmv'] = self.grid_3.GetCellValue(0, 4)
                line_buf['Unit1_Mano_Td'] = self.grid_3.GetCellValue(0, 5)
                ...
                line_buf['Unit2_Mano_P'] = self.grid_3.GetCellValue(1, 1)
                line_buf['Unit2_Mano_P20'] = self.grid_3.GetCellValue(1, 2)
                line_buf['Unit2_Mano_P20_avg'] = self.grid_3.GetCellValue(1, 3)
                line_buf['Unit2_Mano_ppmv'] = self.grid_3.GetCellValue(1, 4)
                line_buf['Unit2_Mano_Td'] = self.grid_3.GetCellValue(1, 5)
    ...
    def signed_to_int(self, signed_int):
        if signed_int > 32768:
            output = signed_int - 2 ** 16 + 1
        else:
            output = signed_int
        return output

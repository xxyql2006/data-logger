...
# -*- coding: ISO-8859-1 -*-
#
# generated by wxGlade 1.0.4 on Wed Feb 15 10:21:20 2023
#
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.grid_1.SetRowLabelSize(105)
        ...
        sizer_2.Add(self.grid_1, 0, wx.ALL | wx.EXPAND, 7)
    ...
    def do_logging(self, event):
        ...
        try:
            ...
            with open(data_file, 'a', newline='') as csvfile:
                ...
                self.grid_3.SetCellValue([0, 5], '{:.2f}'.format((raw_humid[1] - 2 ** 16 + 1) * 0.01)) # Dew temp with pressure Td
                self.grid_3.SetCellValue([0, 6], '{:.2f}'.format((raw_humid[2] - 2 ** 16 + 1) * 0.01)) # Dew temp with norminal pressure Td0 
                ...
                self.grid_3.SetCellValue([1, 5], '{:.2f}'.format((raw_humid[5] - 2 ** 16 + 1) * 0.01)) # Dew temp with pressure Td
                self.grid_3.SetCellValue([1, 6], '{:.2f}'.format((raw_humid[6] - 2 ** 16 + 1) * 0.01)) # Dew temp with norminal pressure Td0 
